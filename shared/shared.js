...
(function () {
  ...
  const I18N = {
    en: {
      name: 'SubtitleMate',
      autoCaptions: 'Enable SubtitleMate',
      autoCaptionsHint: 'Master switch for this extension',
      ...
      autoOnYt: 'Auto-click CC button on video pages',
      autoOnYtHint: 'Automatically clicks the "CC" button in the YouTube player',
    ...
    zh: {
      name: 'SubtitleMate',
      autoCaptions: '启用 SubtitleMate',
      autoCaptionsHint: '扩展总开关',
      captionMode: '字幕模式',
      modeTranslate: '自动翻译',
      modeAutoGenerated: '英语（自动生成）',
      targetLang: '翻译为',
      targetLangHint: '仅在「自动翻译」模式下生效',
      autoOnYt: '进入视频页自动点击字幕按钮',
      autoOnYtHint: '检测到 YouTube 视频时，自动点击播放器右下角“CC”按钮',
